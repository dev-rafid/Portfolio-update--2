// portfolio.js - Updated with Formspree Integration
...
function initContactForm() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                showNotification(`Thank you, ${name}! Your message has been sent successfully. I'll reply to ${email} soon.`, 'success');
                contactForm.reset();
